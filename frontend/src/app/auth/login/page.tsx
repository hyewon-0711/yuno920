  ...
  return (
    <div className={styles.container}>
      <div className={styles.logo}>
        ...
        <p className={styles.tagline}>AI 기반 아이 성장 플랫폼</p>
      </div>
      ...
      <form className={styles.form} onSubmit={handleSubmit}>
        ...
        <div className={styles.inputGroup}>
          ...
          <input
            ...
            required
          />
          <a href="/auth/reset-password" className={styles.forgotLink}>비밀번호 찾기</a>
        </div>
      ...
      <div className={styles.footer}>
        <a href="/auth/signup" className={styles.link}>아직 계정이 없나요? 회원가입</a>
      </div>
    </div>
  );
}
